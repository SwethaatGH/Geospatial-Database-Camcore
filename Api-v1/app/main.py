...
async def get_climate_data_timeseries(
    ...
    region: Region = Query(Region.BRAZIL, description="Select region: brazil or indonesia")
):
    # Get the appropriate database session for the region
    async for db in get_db(region.value):
