...
set count=0
for %%f in ("%ppt_DIR%\*.nc") do set /a count+=1
...
for %%f in (*.nc) do (
    ...
    for /L %%m in (1,1,12) do (
        ...
        set "tempfile=%OUTPUT_DIR%\terraclim_ppt_!year!_!month!_temp.tif"
        set "finalfile=%OUTPUT_DIR%\terraclim_ppt_!year!_!month!.tif"
        ...
        if exist "!finalfile!" (
            ...
            REM Try with 'ppt' variable first
            echo Command: "%GDAL_TRANSLATE%" -of GTiff -b %%m -a_srs EPSG:4326 -co COMPRESS=LZW -co TILED=YES "NETCDF:%%f:ppt" "!tempfile!"
            "%GDAL_TRANSLATE%" -of GTiff -b %%m -a_srs EPSG:4326 -co COMPRESS=LZW -co TILED=YES "NETCDF:%%f:ppt" "!tempfile!"
            ...
            if exist "!tempfile!" (
                ...
                echo Failed with 'ppt', trying 'ppt_mm'...
                "%GDAL_TRANSLATE%" -of GTiff -b %%m -a_srs EPSG:4326 -co COMPRESS=LZW -co TILED=YES "NETCDF:%%f:ppt_mm" "!tempfile!"
