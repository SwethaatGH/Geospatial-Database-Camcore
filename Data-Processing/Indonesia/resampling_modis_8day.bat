...
set "INPUT_DIR=Q:\My Drive\Indonesia_MODIS_ET_8day"
set "OUTPUT_DIR=Z:\ENVIROMICS\Indonesia_modis_resampled"
...
for %%f in ("%INPUT_DIR%\*.tif") do (
    rem Extract the filename without extension (e.g., ET_Indonesia_2000-01-01)
    set "FILENAME=%%~nf"

    rem Extract the date part from the filename (e.g., 2000-01-01)
    ...
    rem Construct the new filename in the format modis_et_YYYY_MM_DD.tif
    set "NEW_FILENAME=modis_et_!YEAR!_!MONTH!_!DAY!.tif"
