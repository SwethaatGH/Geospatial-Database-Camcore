...
# Configuration
INPUT_DIR = r"C:\Users\rcavalh\2026_CHIRPS\Resampled"
DB_HOST = "localhost"
DB_PORT = "5433"
...
def main():
    print("=" * 70)
    print("CHIRPS 2026 Upload to covariablesv1.chirps_data")
    print("=" * 70)
    ...
    # Get all CHIRPS 2026 files
    files = sorted(Path(INPUT_DIR).glob("chirps_2026*.tif"))

    if not files:
        print(f"\nERROR: No CHIRPS 2026 files found in {INPUT_DIR}")
        return
