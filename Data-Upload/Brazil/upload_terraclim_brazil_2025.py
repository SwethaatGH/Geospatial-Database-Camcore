"""
TerraClimate Brazil 2025 Upload Script
Appends monthly TerraClimate GeoTIFFs into existing PostGIS table with partition for 2025.
...
# ----------------- CONFIG -----------------
INPUT_DIR = Path(r"Z:\ENVIROMICS\terraclimate\Brazil_TerraClimate_Resampled_2025")
LOG_FILE = INPUT_DIR.parent / "upload_terraclim_brazil_2025_log.txt"

DB_HOST = "localhost"
DB_PORT = "5433"
DB_NAME = "covariablesv1"
DB_USER = "postgres"
DB_PASS = "postgres"
...
def ensure_2025_partition():
    ...
    cur.execute(f"DELETE FROM {TABLE_NAME} WHERE date_id >= '2025-01-01' AND date_id < '2026-01-01';")
    conn.commit()
    conn.close()
...
if __name__ == "__main__":
    print("TerraClimate Brazil 2025 upload")
    ...
    with open(LOG_FILE, "w", encoding="utf-8") as f:
        f.write(f"TerraClimate Brazil 2025 Upload Log\n")
